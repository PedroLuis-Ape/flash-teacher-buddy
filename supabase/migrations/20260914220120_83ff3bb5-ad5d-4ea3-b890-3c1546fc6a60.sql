-- Listas combinadas (embedded lists) v1 — delta idempotente aplicado ao banco real.
...
REVOKE ALL ON FUNCTION public.assert_owned_embedded_list(uuid) FROM anon;
...
REVOKE ALL ON FUNCTION public.embed_source_lists(uuid, uuid[]) FROM anon;
...
REVOKE ALL ON FUNCTION public.embed_cards(uuid, uuid[]) FROM anon;
...
REVOKE ALL ON FUNCTION public.create_embedded_list(uuid, text, text, uuid[]) FROM anon;
...
REVOKE ALL ON FUNCTION public.unembed_cards(uuid, uuid[]) FROM anon;
...
REVOKE ALL ON FUNCTION public.unembed_source_list(uuid, uuid) FROM anon;
...
REVOKE ALL ON FUNCTION public.clear_embedded_list(uuid) FROM anon;
...
REVOKE ALL ON FUNCTION public.get_embedded_list_members(uuid) FROM anon;
...
REVOKE ALL ON FUNCTION public.get_embedded_list_flashcards(uuid) FROM anon;
...
REVOKE ALL ON FUNCTION public.get_embedded_list_card_count(uuid) FROM anon;
