...
const PublicCatalogPage = lazy(() => import("./features/public-materials/PublicCatalogPage"));
                    ...
                    <RouteErrorBoundary>
                      <RouteSuspense>
                        <PageTransition>
                          ...
                          <Route path="/term-check" element={<TermCheck />} />
                          ...
                          <Route path="/:locale/materiais" element={<PublicCatalogPage />} />
