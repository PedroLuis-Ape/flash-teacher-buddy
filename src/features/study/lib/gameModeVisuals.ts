...
export const GAME_MODE_VISUALS: Record<GameModeVisualKey, GameModeVisual> = {
  flip: {
    ...
    description: "Revele o outro lado dos flashcards.",
  ...
  unscramble: {
    ...
    tileClass: "border-indigo-400/35 bg-indigo-500/20",
    cardClass: "border-indigo-500/25 bg-card/95 hover:border-indigo-400/55 hover:bg-indigo-500/10",
  },
  mixed: {
    emoji: "\u{1F3B2}",
    emojiLabel: "dado de jogo",
    description: "Combine rodadas para revisar com variedade.",
    tileClass: "border-teal-400/35 bg-teal-500/20",
    cardClass: "border-teal-500/25 bg-card/95 hover:border-teal-400/55 hover:bg-teal-500/10",
  },
  pronunciation: {
    emoji: "\u{1F3A4}",
