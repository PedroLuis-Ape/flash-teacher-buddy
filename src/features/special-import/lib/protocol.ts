...
9. Se for uma camada/sentido específico, explique somente esse sentido.
10. Use português simples e útil para aluno brasileiro. Use null apenas quando realmente não houver observação relevante.
