...
describe('public teacher classroom view reuse', () => {
  it('reads classrooms from the existing public view', () => {
  ...
  it('keeps profile visibility filters and public classroom counts', () => {
  ...
  it('does not call the discarded lookup name from the page', () => {
    expect(page).not.toContain("'get_public_teacher_turmas'");
  });
});
