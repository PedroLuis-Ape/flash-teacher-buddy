# Voltar ao card anterior em todos os modos
...
6. Adicionar testes de regressão para retorno contínuo, retorno em rodada, substituição da resposta e limites no primeiro card.
